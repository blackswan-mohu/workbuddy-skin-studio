...
#
# 用法（终端，二选一）：
#   curl -fsSL https://raw.githubusercontent.com/blackswan-mohu/workbuddy-skin-studio/main/install.sh | bash
#   bash install.sh
#
# 自定义仓库地址 / 分支（可选）：
#   DOUBAO_SKIN_REPO=https://github.com/blackswan-mohu/workbuddy-skin-studio.git \
...
REPO_URL="${DOUBAO_SKIN_REPO:-https://github.com/blackswan-mohu/workbuddy-skin-studio.git}"
